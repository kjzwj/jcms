...
<div class="row-fluid">
  <form class="form-horizontal" action="<?php echo U('add');?>" method="post" id="info_form" name="info_form">
    <fieldset>
      <legend><?php echo L('block_add');?></legend>
      
      <div class="control-group">
        <label class="control-label" for="title"><?php echo L('block_name');?></label>
        <div class="controls">
      ...
      <div class="control-group">
        <label class="control-label" for="cell_name"><?php echo L('cell_name');?></label>
        <div class="controls">
      ...
      <div class="control-group">
        <div class="controls" style="margin-left:50px;">
          <script id="body" name="content" type="text/plain" class=""></script><script type="text/javascript" src="__DATA__ueditor/ueditor.config.js"></script><script type="text/javascript" src="__DATA__ueditor/ueditor.all.js"></script><script type="text/javascript">var editor = UE.getEditor("body",{"initialFrameWidth":760,"initialFrameHeight":450});</script> 
        </div>
      </div>
      
      <div class="form-actions">
        <button type="submit" class="btn btn-primary"><?php echo L('lable_submit');?></button>
        <button class="btn" type="reset" onclick="history.back()"><?php echo L('lable_back');?></button>
