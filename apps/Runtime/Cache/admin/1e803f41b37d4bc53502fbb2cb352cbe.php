    ...
    <fieldset>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="base">
            ...
            <div class="controls">
              <select class="J_cate_select" data-pid="0" data-uri="<?php echo U('category/ajax_getchilds');?>" data-selected="<?php echo ($info["spid"]); ?>"></select>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input name="name" type="text" class="input-xlarge" id="name" value="<?php echo ($info["name"]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-large" name="alias" id="alias" value="<?php echo ($info["alias"]); ?>" placeholder="URL目录" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-small" name="ordid" id="ordid" value="<?php echo ($info["ordid"]); ?>" />
            </div>
          </div>
          ...
          <div class="control-group hide-page hide-url">
            ...
            <div class="controls">
              <select id="modelid" name="modelid" onchange="load_file_list(this.value)">
                ...
                <?php if(is_array($model_list)): $i = 0; $__LIST__ = $model_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$model): $mod = ($i % 2 );++$i; if($model['status'] == 1): ?><option value="<?php echo ($model["id"]); ?>" <?php if($info['modelid'] == $model['id']): ?>selected="selected"<?php endif; ?>><?php echo ($model["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </div>
          </div>            
            ...
            <div class="controls">
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_0" value="0" <?php if($info['type'] == 0): ?>checked="checked"<?php endif; ?>><?php echo L('type_0');?>
              </label>
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_1" value="1" <?php if($info['type'] == 1): ?>checked="checked"<?php endif; ?>><?php echo L('type_1');?>
              </label>
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_2" value="2" <?php if($info['type'] == 2): ?>checked="checked"<?php endif; ?>><?php echo L('type_2');?>
              </label>
            </div>
          </div>           
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <label class="radio inline">
                <input type="radio" name="isnav" id="isnav1" value="1" <?php if($info['isnav'] == 1): ?>checked="checked"<?php endif; ?>> <?php echo L('lable_yes');?>
              </label>
              <label class="radio inline">
                <input type="radio" name="isnav" id="isnav2" value="0" <?php if($info['isnav'] == 0): ?>checked="checked"<?php endif; ?>> <?php echo L('lable_no');?>
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane" id="advance">
          <div class="control-group hide-url show-page">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_index" type="text" class="input-large" id="J_template_index" placeholder="index_default" value="<?php echo ($info["template_index"]); ?>">
          ...
          <div class="control-group hide-page hide-url">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_list" type="text" class="input-large" id="J_template_list" placeholder="list_default" value="<?php echo ($info["template_list"]); ?>">
          ...
          <div class="control-group hide-page hide-url">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_show" type="text" class="input-large" id="J_template_show" placeholder="show_default" value="<?php echo ($info["template_show"]); ?>">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <input type="text" name="image" id="J_image" class="input-xlarge" value="<?php echo ($info["image"]); ?>" />
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input name="seotitle" type="text" class="input-xxlarge" id="seotitle" value="<?php echo ($info["seotitle"]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input name="seokeywords" type="text" class="input-xxlarge" id="seokeywords" value="<?php echo ($info["seokeywords"]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <textarea name="seodescription" id="seodescription" class="input-xxlarge" rows="6"><?php echo ($info["seodescription"]); ?></textarea>
            </div>
          </div>
