...
<h4><?php echo L('cate_manage');?></h4>
<div class="blank20"></div>

<div class="row-fluid J_tablelist" data-acturi="<?php echo U('category/ajax_edit');?>">
  <table class="table table-hover">
    <thead>
      <tr>
        <th width="20" class='text-c'><span data-tdtype="order_by" data-field="id" class="sort_th"><?php echo L('lable_id');?></span></th>
        <th width="60" class="text-c"><span data-tdtype="order_by" data-field="ordid" class="sort_th"><?php echo L('lable_order');?></span></th>
        <th><?php echo L('lable_name');?></th>
        <th width="80"><?php echo L('lable_type');?></th>
        <th width="200" class="text-c"><?php echo L('lable_options');?></th>
      </tr>
    </thead>
    <tbody>
    	<?php echo ($list); ?>
