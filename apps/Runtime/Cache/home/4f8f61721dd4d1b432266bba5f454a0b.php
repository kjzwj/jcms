...
<section class="projects fixed clearfix">
  <div class="container">
    ...
    <div class="row">
      ...
      <?php $map['catid']=27;$map['limit']="15";$map['order']="";$map['image']="";$map['flag']="";$map['fields']="type";$map['pagesize']="";$_data = D('content')->get_list($map);$_list=$_data['list'];$_total=$_data['_total'];$_page=$_data['_page'];foreach ($_list as $val):$val['url']=U("content/view",array("id"=>$val['id']));?><div class="col-md-4 col-sm-offset-0 col-sm-6 col-xs-offset-1 col-xs-10">
        <a href="<?php echo ($val['url']); ?>" title="<?php echo ($val['title']); ?>" class="project">
          <div class="thumbnail animated">
            <img src="<?php echo ($val['image']); ?>" alt="<?php echo ($val['title']); ?>" />
          </div>
          <div class="overlay">
            <div class="meta animated">
              <div class="type"><?php echo ($val['type']); ?></div>
              <div class="client"><?php echo ($val['title']); ?></div>
            </div>
          </div>
        </a>
      </div><?php endforeach; ?>
