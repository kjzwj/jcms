...
<div class="row-fluid">
  ...
  <form class="form-horizontal" action="{:U('add')}" method="post" id="J_checkingForm">
    <fieldset>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="base">
            ...
            <div class="controls">
              ...
              <input type="hidden" name="cat_id" id="J_cate_id" value="{$cat_id}" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <label class="checkbox inline"><input type="checkbox" id="flag_{$key}" name="flag[{$key}]" value="{$key}"> {$vo}</label>
              </foreach>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-large" name="author" id="author" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-small" name="ordid" id="ordid" />
          ...
          <div class="control-group">
            <div class="controls" style="margin-left:50px;">
              <editor type="ueditor" lang="cn" name="body" width="820" height="500" content="{$info.body}"></editor> 
            </div>
          </div> 
        ...
        <div class="tab-pane" id="advance">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-large Wdate" name="addtime" id="addtime" value="<?php echo date('Y-m-d H:i:s');?>" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="input-small" name="click" id="click" />
            </div>
          </div>       
