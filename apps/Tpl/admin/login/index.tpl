...
<!-- Le styles -->
<load type="css" href="__DATA__css/bootstrap.min.css,__DATA__css/bootstrap-responsive.css,__DATA__css/login.css" from="admin" />
...
<body>
<div class="container">
	<form class="form-signin" id="login" action="{:U('signin')}">
		...
		<input type="text" name="verify" class="input-block-level" placeholder="验证码" required="required"><img src="{:U('verify')}" class="verifyimg reloadverify"/>
