  ...
  <form class="form-horizontal" action="{:U('edit')}" method="post" id="info_form" name="info_form">
    <fieldset>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <textarea name="info" rows="6" class="input-xxlarge" id="info">{$info.info}</textarea>
        </div>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <label class="radio inline">
            <input type="radio" name="status" id="status1" value="1" <if condition="$info['status'] eq 1">checked</if>>
            {:L('lable_yes')}
          </label>
          <label class="radio inline">
            <input type="radio" name="status" id="status2" value="0" <if condition="$info['status'] eq 0">checked</if>>
            {:L('lable_no')}
          </label>
        </div>
      </div>      
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <label class="radio inline">
            <input type="radio" name="sendmail" id="sendmail1" value="1" <if condition="$info['sendmail'] eq 1">checked</if>>
            {:L('lable_yes')}
          </label>
          <label class="radio inline">
            <input type="radio" name="sendmail" id="sendmail2" value="0" <if condition="$info['sendmail'] eq 0">checked</if>>
            {:L('lable_no')}
          </label>
        </div>
      </div> 
      ...
      <div class="control-group" id="toemail_div">
        ...
        <div class="controls">
            <input name="toemail" type="email" class="input-xlarge" id="toemail" value="{$info.toemail}">
        </div>
      </div>
