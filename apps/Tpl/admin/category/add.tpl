...
<div class="row-fluid">
  ...
  <form class="form-horizontal" action="{:U('add_category')}" method="post">
    <fieldset>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="base">
          ...
          <div class="control-group">
            ...
            <div class="controls">
            <select class="J_cate_select mr10" data-pid="0" data-uri="{:U('category/ajax_getchilds')}" data-selected="{$spid}"></select>
            ...
            <div class="controls">
              <select id="modelid" name="modelid" onchange="load_file_list(this.value)">
                ...
                <if condition="$model['status'] eq 1">
                  <option value="{$model.id}" <if condition="$pcate['modelid'] eq $model['id']">selected="selected"</if>>{$model.name}</option>
                </if>
                </volist>
              </select>
            </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_0" value="0" <if condition="$pcate['type'] eq 0">checked="checked"</if>>{:L('type_0')}
              </label>
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_1" value="1" <if condition="$pcate['type'] eq 1">checked="checked"</if>>{:L('type_1')}
              </label>
              <label class="radio inline">
                <input type="radio" name="type" onchange="change_type(this.value)" id="type_2" value="2" <if condition="$pcate['type'] eq 2">checked="checked"</if>>{:L('type_2')}
              </label>
            </div>
          </div>      
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <label class="radio inline">
                <input type="radio" name="isnav" id="isnav1" value="1" checked="checked">{:L('lable_yes')}
              </label>
              <label class="radio inline">
                <input type="radio" name="isnav" id="isnav2" value="0">{:L('lable_no')}
              </label>
            </div>
          </div>
        ...
        <div class="tab-pane" id="advance">
          <div class="control-group hide-url show-page">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_index" type="text" class="input-large" id="J_template_index" placeholder="index_default" value="{$pcate.template_index}">
          ...
          <div class="control-group hide-page hide-url">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_list" type="text" class="input-large" id="J_template_list" placeholder="list_default" value="{$pcate.template_list}">
          ...
          <div class="control-group hide-page hide-url">
            ...
            <div class="controls">
                <div class="input-append"><input name="template_show" type="text" class="input-large" id="J_template_show" placeholder="show_default" value="{$pcate.template_show}">
        ...
        <div class="tab-pane" id="content">
      		<editor type="ueditor" lang="cn" name="body"></editor> 
